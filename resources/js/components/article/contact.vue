<template>
  <div class="form-a">
      <div class="row">
        <div class="col-md-12 mb-1">
          <div class="form-group">
            <input type="text" class="form-control form-control-lg form-control-a" id="inputName" name="name"
              :placeholder="placeholder_name" required v-model="name">
          </div>
        </div>
        <div class="col-md-12 mb-1">
          <div class="form-group">
        ...
        <div class="form-group">
          <input type="checkbox" name="accepted"           v-model="accepted" value="1" required> <a :href="route_data_handling" target="_blank"
          >{{accepted_terms}}

           </a>
        </div>

          <button type="submit" class="btn btn-a " @click.prevent="send" >{{send_button}}</button>
        </div>
