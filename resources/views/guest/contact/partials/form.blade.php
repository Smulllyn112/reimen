                ...
                <div class="row">
                    <div class="col-md-7 pr-60 res-767-pr-15">
                        ...
                        <div class="section-title with-desc clearfix">
                            ...
                            <div class="title-desc">Küldje el kérdését, és munkatársunk hamarosan megválaszolja azt.</div>
                        ...
                        <form id="ttm-contactform" class="ttm-contactform wrap-form clearfix" method="post" action="{{route('contact.store')}}">
                            ...
                            <input type="submit" id="submit" class="ttm-btn ttm-btn-size-lg ttm-btn-shape-square ttm-btn-style-fill ttm-icon-btn-right ttm-btn-bgcolor-black" value="ÜZENET ELKÜLDÉSE">
                        </form>
                    </div>
                    <div class="col-md-5">
                        <div class="ttm-rounded-shadow-box pt-40 pr-50 pb-55 pl-50 box-shadow2 res-767-mt-40 clearfix">
                            ...
                            <ul class="ttm_contact_widget_wrapper">
                                <li><i class="ttm-textcolor-skincolor ti ti-location-pin"></i>Budapest és Környéke</li>
                                ...
                                <li><i class="ttm-textcolor-skincolor ti ti-world"></i><a href="{{env('APP_URL')}}">tetofedo-badogos.eu/</a></li>
                            </ul>
